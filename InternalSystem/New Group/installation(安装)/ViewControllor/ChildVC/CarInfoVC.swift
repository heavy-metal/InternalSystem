...
class CarInfoVC: BaseTableViewVC {
    var refreshCount = 1
    var searchtext = ""
    lazy var CarArray = [CarModel]()
    lazy var firstSaveArray = [CarModel]()
    ...
    override func viewDidLoad() {
        ...
        setupfooter()
        setUI()
        NotificationCenter.default.addObserver(forName: NSNotification.Name("CarInfo"), object: nil, queue: nil) { (info) in
...
extension CarInfoVC {
    ...
    fileprivate func getData(_ firstGet:Bool){
        if let userInfo = ZJKeyChain.load("userInfo") as? [String:String] {
            ...
            StockTool.SearchCar(params: params as? [String : String], Success: { (page, array) in
                self.page = page
                ...
                if firstGet == true {
                    ...
                    self.CarArray.append(contentsOf: array)
                }
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        VC.carModel = CarArray[indexPath.row]
        VC.detailType = .CarInfo
...
extension CarInfoVC{
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let model = CarArray[indexPath.row]
...
extension CarInfoVC : UISearchResultsUpdating ,UISearchBarDelegate {
    
    
    func searchBarShouldBeginEditing(_ searchBar: UISearchBar) -> Bool {
        let searchRequestVC = SearchRequestVC()
        searchRequestVC.purchaseSearchType = .CarInfo
    ...
    func searchBarBookmarkButtonClicked(_ searchBar: UISearchBar) {
        ...
        self.CarArray = self.firstSaveArray
