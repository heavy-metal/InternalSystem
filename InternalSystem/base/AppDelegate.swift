...
class AppDelegate: UIResponder, UIApplicationDelegate ,UNUserNotificationCenterDelegate{
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        window?.rootViewController = UINavigationController(rootViewController: LoginViewControllor())
        
        window?.makeKeyAndVisible()
        
//        self.remotePush(launchOptions)//集成友盟推送
        PushRemoteTool.shared.RegisterPush(launchOptions:launchOptions)
...
//        self.window?.rootViewController?.present(CustomNavigationController(rootViewController: purchasDeTailVC), animated: true, completion: nil)
//        }) { (error) in
...
//                self.window?.rootViewController?.present(CustomNavigationController(rootViewController: salsesOrderFormDetailVC), animated: true, completion: nil)
//            })
//            
//                
//        }) { (error) in
